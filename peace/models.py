...
class Suspect(models.Model):
    unique_id = models.CharField(primary_key=True, unique=True, help_text="Enter a valid Suspect Unique Identifier")
    first_name = models.CharField(max_length=200, help_text="Enter a valid First Name")
    last_name = models.CharField(max_length=200, help_text="Enter a valid Last Name")
...
class Feedback(models.Model):
    feedback_id = models.models.AutoField(primary_key=True)
...
class Case(models.Model):
    case_description = models.ForeignKey(Case, primary_key=True, on_delete=models.CASCADE)
...
class CaseCollection(models.Model):
    case_id = models.CharField(primary_key=True, unique=True, help_text="Enter a valid Case Identifier")
